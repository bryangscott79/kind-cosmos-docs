...
import { Copy, Check, Send, Sparkles, ChevronDown } from "lucide-react";
import DashboardLayout from "@/components/layout/DashboardLayout";
import { prospects, industries, outreachContent, signals, getScoreColor, getPressureLabel, getPressureColor } from "@/data/mockData";
...
export default function Outreach() {
  ...
  const existingContent = outreachContent.filter((o) => o.prospectId === selectedProspectId);
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-border bg-card">
            ...
            <textarea
              ...
              placeholder="Click 'Generate' to create AI-powered outreach content based on the selected prospect and relevant signals..."
              className="w-full min-h-[360px] resize-none bg-transparent p-4 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none leading-relaxed"
            />
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-medium text-foreground hover:bg-accent transition-colors disabled:opacity-50"
              >
            ...
            <div className="rounded-lg border border-border bg-card p-4">
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className={`text-xs font-medium text-${getPressureColor(selectedProspect.pressureResponse)}`}>
                    {getPressureLabel(selectedProspect.pressureResponse)}
                  </p>
                </div>
              </div>
