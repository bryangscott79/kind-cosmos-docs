                  ...
                  <section>
                    ...
                    <div className="space-y-2">
                      {criticalAlerts.map((signal) => {
                        ...
                        return (
                          <div key={signal.id} className="rounded-lg border border-rose-200/50 bg-rose-50/30 p-4">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 flex-wrap mb-1">
                                  ...
                                  <span className="text-[10px] text-muted-foreground">
                                    {signal.industryTags.map((t) => getIndustryName(t)).filter(n => n !== "Unknown").join(", ")}
                                  </span>
                                </div>
                                <h3 className="text-sm font-semibold text-foreground leading-snug">{signal.title}</h3>
                                <p className="text-xs text-muted-foreground mt-1">{signal.salesImplication}</p>
                                {affected.length > 0 && (
