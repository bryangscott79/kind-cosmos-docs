...
function getIndustryName(id: string) {
  return industries.find((i) => i.id === id)?.name ?? "Unknown";
}
    ...
    <DashboardLayout>
      ...
      {!search && (
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          ...
          {/* Right column: Prospects + Industries */}
          <div className="space-y-6">
            ...
            <section>
              <div className="flex items-center justify-between mb-3">
                ...
                <Link to="/industries" className="text-xs font-medium text-primary hover:text-primary/80 transition-colors flex items-center gap-1">
                  All industries <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
              ...
              <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="shrink-0">
                        <TrendingUp className="h-3.5 w-3.5 text-score-green" />
                      </div>
                ...
                {industryMovers.declining.map((ind) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="shrink-0">
                        <TrendingDown className="h-3.5 w-3.5 text-score-red" />
                      </div>
                      <div className="min-w-0">
                        <span className="text-sm font-medium text-foreground truncate block">{ind.name}</span>
